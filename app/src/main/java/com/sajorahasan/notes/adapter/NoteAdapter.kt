package com.sajorahasan.notes.adapter
...
class NoteAdapter : RecyclerView.Adapter<NoteAdapter.NoteHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): NoteHolder {
        ...
        return NoteHolder(itemView)//To change body of created functions use File | Settings | File Templates.
    }
    ...
    override fun onBindViewHolder(holder: NoteHolder, position: Int) {
        ...
        holder.textViewDescription.text =
            currentNote.description //To change body of created functions use File | Settings | File Templates.
    }
